  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        letter: "ನ",
        word: "ನಯನ",
        image: getAssetUrl(s3Assets.ನಯನImg),
        audio: getAssetAudioUrl(s3Assets.ನಯನAudio),
        singleAudio: getAssetAudioUrl(s3Assets.ನಯನAudio),
        alaphabetChartAudio: getAssetAudioUrl(s3Assets.ನಯನAudio),
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        letter: "ಧ",
        word: "ಧಗಧಗ",
        image: getAssetUrl(s3Assets.ಧಗಧಗImg),
        audio: getAssetAudioUrl(s3Assets.ಧಗಧಗAudio),
        singleAudio: getAssetAudioUrl(s3Assets.ಧಗಧಗAudio),
        alaphabetChartAudio: getAssetAudioUrl(s3Assets.ಧಗಧಗAudio),
      },
      {
        id: 80,
        title: "Letter",
