  ...
  hi: [
    {
      allwords: [
        {
          img: getAssetUrl(s3Assets.ऐनकImg),
          text: "ऐनक",
          audio: getAssetAudioUrl(s3Assets.ऐनकAudio),
        },
        {
          img: getAssetUrl(s3Assets.शहदImg),
          text: "शहद",
          audio: getAssetAudioUrl(s3Assets.शहदAudio),
        },
        {
          img: getAssetUrl(s3Assets.ओखलImg),
          text: "ओखल",
    ...
    },
    {
      allwords: [
        ...
        {
          img: getAssetUrl(s3Assets.कमलImg),
          text: "कमल",
          audio: getAssetAudioUrl(s3Assets.कमलAudio),
        },
        {
          img: getAssetUrl(s3Assets.ततImg),
          text: "तोता",
          audio: getAssetAudioUrl(s3Assets.ततAudio),
        },
      ],
      correctWord: "कमल",
      audio: getAssetAudioUrl(s3Assets.कमलAudio),
    ...
    },
    {
      allwords: [
        ...
        {
          img: getAssetUrl(s3Assets.समयImg),
          text: "समय",
          audio: getAssetAudioUrl(s3Assets.समयAudio),
        },
        {
          img: getAssetUrl(s3Assets.झलImg),
          text: "झोला",
          audio: getAssetAudioUrl(s3Assets.झलAudio),
        },
      ],
      correctWord: "समय",
      audio: getAssetAudioUrl(s3Assets.समयAudio),
    ...
    },
    {
      allwords: [
        ...
        {
          img: getAssetUrl(s3Assets.नमनImg),
          text: "नमन",
          audio: getAssetAudioUrl(s3Assets.नमनAudio),
        },
      ],
      correctWord: "नमन",
      audio: getAssetAudioUrl(s3Assets.नमनAudio),
    ...
    },
    {
      allwords: [
        {
          img: getAssetUrl(s3Assets.खनImg),
          text: "खाना",
          audio: getAssetAudioUrl(s3Assets.खनAudio),
        },
        {
          img: getAssetUrl(s3Assets.कमलImg),
          text: "कमल",
    ...
    },
    {
      allwords: [
        {
          img: getAssetUrl(s3Assets.कलमImg),
          text: "कलम",
          audio: getAssetAudioUrl(s3Assets.कलमAudio),
        },
        {
          img: getAssetUrl(s3Assets.नमनImg),
          text: "नमन",
    ...
    },
    {
      allwords: [
        ...
        {
          img: getAssetUrl(s3Assets.चहImg),
          text: "चूहा",
          audio: getAssetAudioUrl(s3Assets.चहAudio),
        },
      ],
      correctWord: "ओखल",
      audio: getAssetAudioUrl(s3Assets.ओखलAudio),
    ...
    },
    {
      allwords: [
        ...
        {
          img: getAssetUrl(s3Assets.तालाImg),
          text: "ताला",
          audio: getAssetAudioUrl(s3Assets.तालाAudio),
        },
        {
          img: getAssetUrl(s3Assets.नगरImg),
          text: "नगर",
    ...
    },
    {
      allwords: [
        ...
        {
          img: getAssetUrl(s3Assets.महलImg),
          text: "महल",
    ...
    },
    {
      allwords: [
        {
          img: getAssetUrl(s3Assets.रटImg),
          text: "रोटी",
          audio: getAssetAudioUrl(s3Assets.रटAudio),
        },
        {
          img: getAssetUrl(s3Assets.मतImg),
          text: "मोती",
          audio: getAssetAudioUrl(s3Assets.मतAudio),
        },
        {
          img: getAssetUrl(s3Assets.झलImg),
          text: "झोला",
    ...
    },
    {
      allwords: [
        ...
        {
          img: getAssetUrl(s3Assets.कटरImg),
          text: "कटोरी",
          audio: getAssetAudioUrl(s3Assets.कटरAudio),
        },
      ],
      correctWord: "रोटी",
      audio: getAssetAudioUrl(s3Assets.रटAudio),
    ...
    },
    {
      allwords: [
        {
          img: getAssetUrl(s3Assets.पयजImg),
          text: "प्याज",
          audio: getAssetAudioUrl(s3Assets.पयजAudio),
        },
        {
          img: getAssetUrl(s3Assets.रतरImg),
          text: "रात्रि",
          audio: getAssetAudioUrl(s3Assets.रतरAudio),
        },
        {
          img: getAssetUrl(s3Assets.परकतImg),
          text: "प्रकृति",
          audio: getAssetAudioUrl(s3Assets.परकतAudio),
        },
      ],
      correctWord: "प्याज",
      audio: getAssetAudioUrl(s3Assets.पयजAudio),
    ...
    },
    {
      allwords: [
        {
          img: getAssetUrl(s3Assets.कबडडImg),
          text: "कबड्डी",
          audio: getAssetAudioUrl(s3Assets.कबडडAudio),
        },
        {
          img: getAssetUrl(s3Assets.वरषImg),
          text: "वर्षा",
          audio: getAssetAudioUrl(s3Assets.वरषAudio),
        },
        {
          img: getAssetUrl(s3Assets.कततImg),
          text: "कुत्ता",
    ...
    },
    {
      allwords: [
        ...
        {
          img: getAssetUrl(s3Assets.सकलImg),
          text: "स्कूल",
          audio: getAssetAudioUrl(s3Assets.सकलAudio),
        },
      ],
      correctWord: "स्कूल",
      audio: getAssetAudioUrl(s3Assets.सकलAudio),
    ...
    },
    {
      allwords: [
        ...
        {
          img: getAssetUrl(s3Assets.कलफImg),
          text: "कुल्फ़ी",
          audio: getAssetAudioUrl(s3Assets.कलफAudio),
        },
        {
          img: getAssetUrl(s3Assets.परकतImg),
          text: "प्रकृति",
    ...
    },
    {
      allwords: [
        {
          img: getAssetUrl(s3Assets.तसवरImg),
          text: "तस्वीर",
          audio: getAssetAudioUrl(s3Assets.तसवरAudio),
        },
        {
          img: getAssetUrl(s3Assets.पयजImg),
          text: "प्याज",
        ...
        {
          img: getAssetUrl(s3Assets.सखयImg),
          text: "संख्या",
          audio: getAssetAudioUrl(s3Assets.सखयAudio),
        },
      ],
      correctWord: "संख्या",
      audio: getAssetAudioUrl(s3Assets.सखयAudio),
    ...
    },
    {
      allwords: [
        ...
        {
          img: getAssetUrl(s3Assets.बसतरImg),
          text: "बिस्तर",
          audio: getAssetAudioUrl(s3Assets.बसतरAudio),
        },
        {
          img: getAssetUrl(s3Assets.रससImg),
          text: "रस्सी",
    ...
    },
    {
      allwords: [
        {
          img: getAssetUrl(s3Assets.सबजImg),
          text: "सब्ज़ी",
          audio: getAssetAudioUrl(s3Assets.सबजAudio),
        },
        {
          img: getAssetUrl(s3Assets.पतथरImg),
          text: "पत्थर",
          audio: getAssetAudioUrl(s3Assets.पतथरAudio),
        },
        {
          img: getAssetUrl(s3Assets.कबडडImg),
          text: "कबड्डी",
    ...
    },
    {
      allwords: [
        ...
        {
          img: getAssetUrl(s3Assets.शकषकImg),
          text: "शिक्षक",
          audio: getAssetAudioUrl(s3Assets.शकषकAudio),
        },
      ],
      correctWord: "शिक्षक",
      audio: getAssetAudioUrl(s3Assets.शकषकAudio),
    ...
    },
    {
      allwords: [
        ...
        {
          img: getAssetUrl(s3Assets.तरशलImg),
          text: "त्रिशूल",
    ...
    },
    {
      allwords: [
        {
          img: getAssetUrl(s3Assets.वदयलयImg),
          text: "विद्यालय",
          audio: getAssetAudioUrl(s3Assets.वदयलयAudio),
        },
        {
          img: getAssetUrl(s3Assets.बसतरImg),
          text: "बिस्तर",
  ...
  ne: [
    {
      allwords: [
        {
          img: getAssetUrl(s3Assets.ऊनImg),
          text: "ऊन",
          audio: getAssetAudioUrl(s3Assets.ऊनAudio),
        },
        {
          img: getAssetUrl(s3Assets.कागImg),
          text: "काग",
          audio: getAssetAudioUrl(s3Assets.कागAudio),
        },
        {
          img: getAssetUrl(s3Assets.जराImg),
          text: "जरा",
          audio: getAssetAudioUrl(s3Assets.जराAudio),
        },
      ],
      correctWord: "जरा",
      audio: getAssetAudioUrl(s3Assets.जराAudio),
    ...
    },
    {
      allwords: [
        ...
        {
          img: getAssetUrl(s3Assets.मेवाImg),
          text: "मेवा",
          audio: getAssetAudioUrl(s3Assets.मेवाAudio),
        },
        {
          img: getAssetUrl(s3Assets.कागImg),
          text: "काग",
    ...
    },
    {
      allwords: [
        {
          img: getAssetUrl(s3Assets.शंखImg),
          text: "शंख",
          audio: getAssetAudioUrl(s3Assets.शंखAudio),
        },
        {
          img: getAssetUrl(s3Assets.हलोImg),
          text: "हलो",
          audio: getAssetAudioUrl(s3Assets.हलोAudio),
        },
        {
          img: getAssetUrl(s3Assets.मगImg),
          text: "मग",
    ...
    },
    {
      allwords: [
        ...
        {
          img: getAssetUrl(s3Assets.शरीरImg),
          text: "शरीर",
          audio: getAssetAudioUrl(s3Assets.शरीरAudio),
        },
      ],
      correctWord: "शंख",
      audio: getAssetAudioUrl(s3Assets.शंखAudio),
    ...
    },
    {
      allwords: [
        {
          img: getAssetUrl(s3Assets.बजारImg),
          text: "बजार",
          audio: getAssetAudioUrl(s3Assets.बजारAudio),
        },
        {
          img: getAssetUrl(s3Assets.ढकImg),
          text: "ढक",
    ...
    },
    {
      allwords: [
        ...
        {
          img: getAssetUrl(s3Assets.करेलाImg),
          text: "करेला",
          audio: getAssetAudioUrl(s3Assets.करेलाAudio),
        },
      ],
      correctWord: "पढ़",
      audio: getAssetAudioUrl(s3Assets.पढ़Audio),
    ...
    },
    {
      allwords: [
        {
          img: getAssetUrl(s3Assets.दहीImg),
          text: "दही",
          audio: getAssetAudioUrl(s3Assets.दहीAudio),
        },
        {
          img: getAssetUrl(s3Assets.हलोImg),
          text: "हलो",
        ...
        {
          img: getAssetUrl(s3Assets.छोरोImg),
          text: "छोरो",
          audio: getAssetAudioUrl(s3Assets.छोरोAudio),
        },
      ],
      correctWord: "दही",
      audio: getAssetAudioUrl(s3Assets.दहीAudio),
    ...
    },
    {
      allwords: [
        ...
        {
          img: getAssetUrl(s3Assets.थैलीImg),
          text: "थैली",
          audio: getAssetAudioUrl(s3Assets.थैलीAudio),
        },
      ],
      correctWord: "छोरो",
      audio: getAssetAudioUrl(s3Assets.छोरोAudio),
    ...
    },
    {
      allwords: [
        {
          img: getAssetUrl(s3Assets.किराImg),
          text: "किरा",
          audio: getAssetAudioUrl(s3Assets.किराAudio),
        },
        {
          img: getAssetUrl(s3Assets.समय2Img),
          text: "समय",
    ...
    },
    {
      allwords: [
        ...
        {
          img: getAssetUrl(s3Assets.परालImg),
          text: "पराल",
          audio: getAssetAudioUrl(s3Assets.परालAudio),
        },
      ],
      correctWord: "पराल",
      audio: getAssetAudioUrl(s3Assets.परालAudio),
    ...
    },
    {
      allwords: [
        ...
        {
          img: getAssetUrl(s3Assets.केराImg),
          text: "केरा",
          audio: getAssetAudioUrl(s3Assets.केराAudio),
        },
      ],
      correctWord: "केरा",
      audio: getAssetAudioUrl(s3Assets.केराAudio),
    ...
    },
    {
      allwords: [
        {
          img: getAssetUrl(s3Assets.धक्कोImg),
          text: "धक्को",
          audio: getAssetAudioUrl(s3Assets.धक्कोAudio),
        },
        {
          img: getAssetUrl(s3Assets.विभिन्नImg),
          text: "विभिन्न",
          audio: getAssetAudioUrl(s3Assets.विभिन्नAudio),
        },
        {
          img: getAssetUrl(s3Assets.बच्चाImg),
          text: "बच्चा",
          audio: getAssetAudioUrl(s3Assets.बच्चाAudio),
        },
      ],
      correctWord: "बच्चा",
      audio: getAssetAudioUrl(s3Assets.बच्चाAudio),
    ...
    },
    {
      allwords: [
        ...
        {
          img: getAssetUrl(s3Assets.घरभित्रImg),
          text: "घरभित्र",
          audio: getAssetAudioUrl(s3Assets.घरभित्रAudio),
        },
        {
          img: getAssetUrl(s3Assets.विभिन्नImg),
          text: "विभिन्न",
    ...
    },
    {
      allwords: [
        ...
        {
          img: getAssetUrl(s3Assets.पञ्जाImg),
          text: "पञ्जा",
          audio: getAssetAudioUrl(s3Assets.पञ्जाAudio),
        },
        {
          img: getAssetUrl(s3Assets.झण्डाImg),
          text: "झण्डा",
    ...
    },
    {
      allwords: [
        ...
        {
          img: getAssetUrl(s3Assets.सब्जीImg),
          text: "सब्जी",
          audio: getAssetAudioUrl(s3Assets.सब्जीAudio),
        },
      ],
      correctWord: "उल्लू",
      audio: getAssetAudioUrl(s3Assets.उल्लूAudio),
    ...
    },
    {
      allwords: [
        {
          img: getAssetUrl(s3Assets.राज्यImg),
          text: "राज्य",
          audio: getAssetAudioUrl(s3Assets.राज्यAudio),
        },
        {
          img: getAssetUrl(s3Assets.धक्कोImg),
          text: "धक्को",
    ...
    },
    {
      allwords: [
        {
          img: getAssetUrl(s3Assets.डाक्टरImg),
          text: "डाक्टर",
          audio: getAssetAudioUrl(s3Assets.डाक्टरAudio),
        },
        {
          img: getAssetUrl(s3Assets.शब्दImg),
          text: "शब्द",
          audio: getAssetAudioUrl(s3Assets.शब्दAudio),
        },
        {
          img: getAssetUrl(s3Assets.झण्डाImg),
          text: "झण्डा",
    ...
    },
    {
      allwords: [
        ...
        {
          img: getAssetUrl(s3Assets.जङ्गलमाImg),
          text: "जङ्गलमा",
          audio: getAssetAudioUrl(s3Assets.जङ्गलमाAudio),
        },
      ],
      correctWord: "राज्य",
      audio: getAssetAudioUrl(s3Assets.राज्यAudio),
    ...
    },
    {
      allwords: [
        ...
        {
          img: getAssetUrl(s3Assets.चित्रImg),
          text: "चित्र",
    ...
    },
    {
      allwords: [
        {
          img: getAssetUrl(s3Assets.स्कूलImg),
          text: "स्कूल",
          audio: getAssetAudioUrl(s3Assets.स्कूलAudio),
        },
        {
          img: getAssetUrl(s3Assets.पञ्जाImg),
          text: "पञ्जा",
        ...
        {
          img: getAssetUrl(s3Assets.उत्सवImg),
          text: "उत्सव",
          audio: getAssetAudioUrl(s3Assets.उत्सवAudio),
        },
      ],
      correctWord: "स्कूल",
      audio: getAssetAudioUrl(s3Assets.स्कूलAudio),
    ...
    },
    {
      allwords: [
        ...
        {
          img: getAssetUrl(s3Assets.रङ्गीनImg),
          text: "रङ्गीन",
          audio: getAssetAudioUrl(s3Assets.रङ्गीनAudio),
        },
      ],
      correctWord: "उत्सव",
      audio: getAssetAudioUrl(s3Assets.उत्सवAudio),
    ...
    },
    {
      allwords: [
        {
          img: getAssetUrl(s3Assets.हड्डीImg),
          text: "हड्डी",
          audio: getAssetAudioUrl(s3Assets.हड्डीAudio),
        },
        {
          img: getAssetUrl(s3Assets.चित्रImg),
          text: "चित्र",
    ...
    },
    {
      allwords: [
        ...
        {
          img: getAssetUrl(s3Assets.शब्दहरूImg),
          text: "शब्दहरू",
          audio: getAssetAudioUrl(s3Assets.शब्दहरूAudio),
        },
      ],
      correctWord: "शब्दहरू",
      audio: getAssetAudioUrl(s3Assets.शब्दहरूAudio),
    ...
    },
    {
      allwords: [
        ...
        {
          img: getAssetUrl(s3Assets.हात्तीImg),
          text: "हात्ती",
          audio: getAssetAudioUrl(s3Assets.हात्तीAudio),
        },
      ],
      correctWord: "हात्ती",
      audio: getAssetAudioUrl(s3Assets.हात्तीAudio),
            ...
            >
              <div
                style={{
                  ...
                  width: isMobile ? "240px" : "128px",
                  height: isMobile ? "240px" : "128px",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                  backdropFilter: "blur(56px)",
