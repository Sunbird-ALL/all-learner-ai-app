...
const demoInstructions = {
  ...
  ne: {
    demoSentence: "बिरालो सुतिरहेको छ।",
    narration1:
      "वाक्य हेर्नुहोस्। बिरालो सुतिरहेको छ। अब माइक्रोफोन बटनमा क्लिक गरेर आफैं भन्नको लागि रेकर्ड गर्नुहोस्",
    narration2:
      "अब अडियो रेकर्ड गर्नुहोस्। बोल्न सकिएपछि स्टप आइकनमा क्लिक गर्नुहोस्",
    narration3: "रेकर्ड गरिएको अडियो सुन्नको लागि प्ले बटनमा क्लिक गर्नुहोस्",
    narration4: "फेरि अडियो रेकर्ड गर्नको लागि रिट्राई बटनमा क्लिक गर्नुहोस्",
    narration5: "अगाड़ि बढ्नको लागि कन्टिन्यूमा क्लिक गर्नुहोस्",
...
const DiscoverSentencePreview = ({ onStartGame, onBack }) => {
  ...
  const completionMessages = {
    ...
    ne: {
      ...
      message: "धेरै राम्रो! तपाईं सुरू गर्न तयार हुनुहुन्छ।",
