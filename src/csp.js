export const getCSP = (envVariables) => {
  ...
  return [
    ...
    `connect-src 'self' https://*.amazonaws.com https://*.theall.ai https://*.the-axl.ai https://telemetry.theall.ai https://telemetry-dev.theall.ai ${telemetry} ${host} ${aiBase} ${orchestHost} ${s3Url} ${s3Content} ${presignedUrlService} blob: https://huggingface.co https://cas-bridge.xethub.hf.co https://cdn.jsdelivr.net`.trim(),
    "form-action 'self'",
