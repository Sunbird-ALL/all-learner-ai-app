// Static practice content data — extracted from Practice.jsx
// These objects are defined here (outside the component) to avoid re-creation on every render.
import { getAssetUrl, getAssetAudioUrl } from "../utils/s3Links";
