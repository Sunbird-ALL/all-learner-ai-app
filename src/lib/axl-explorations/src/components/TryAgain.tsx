...
import { TrendingUp, Home, RotateCcw, ChevronRight } from "lucide-react";
...
export function TryAgain({ 
  ...
  return (
    <div className={`h-full bg-gradient-cool flex items-center justify-center p-2 sm:p-4 transition-opacity duration-700 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
