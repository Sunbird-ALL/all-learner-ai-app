...
const gameInstructions = {
  ...
  hi: {
    title: "अक्षर पहचान",
    description: "अक्षर की आवाज़ सुनें और मिलता-जुलता अक्षर खोजें!",
    steps: [
      "🔊 स्पीकर पर क्लिक करके अक्षर की आवाज़ सुनें",
      "🎯 सही अक्षर पर क्लिक करें",
      "✨ सही उत्तरों के लिए अंक पाएं!",
    ],
    instruction1: "अक्षर की आवाज़ सुनने के लिए स्पीकर आइकन पर क्लिक करें",
    instruction2: "अक्षर की आवाज़ ध्यान से सुनें",
    instruction3: "अब, नीचे दिए गए विकल्पों में से मिलता-जुलता अक्षर क्लिक करें",
    instruction4: "शाबाश! आपने डेमो सफलतापूर्वक पूरा किया!",
    successMessage: "🎉 सही!",
    failureMessage: "😢 अरे! गलत!",
    narration1: "अक्षर की आवाज़ सुनने के लिए स्पीकर आइकन पर क्लिक करें",
    narration2: "अक्षर की आवाज़ ध्यान से सुनें",
    narration3: "अब, नीचे दिए गए विकल्पों में से मिलता-जुलता अक्षर क्लिक करें",
    narration4: "शाबाश! आपने डेमो सफलतापूर्वक पूरा किया!",
    howToPlay: "कैसे खेलें",
    demo: {
      audio: "अ",
      options: ["अ", "आ", "इ", "ई"],
      correctAnswer: "अ",
      explanation: "आवाज़ 'अ' अक्षर 'अ' से मेल खाती है!",
    },
  },
  ne: {
    title: "अक्षर चिनाइ",
    description: "अक्षरको आवाज सुन्नुहोस् र मिल्दो अक्षर खोज्नुहोस्!",
    steps: [
      "🔊 स्पिकरमा क्लिक गरी अक्षरको आवाज सुन्नुहोस्",
      "🎯 सही अक्षरमा क्लिक गर्नुहोस्",
      "✨ सही उत्तरका लागि अंक पाउनुहोस्!",
    ],
    instruction1: "अक्षरको आवाज सुन्नको लागि स्पिकर आइकनमा क्लिक गर्नुहोस्",
    instruction2: "अक्षरको आवाज ध्यानपूर्वक सुन्नुहोस्",
    instruction3: "अब, तलका विकल्पहरूबाट मिल्दो अक्षरमा क्लिक गर्नुहोस्",
    instruction4: "धेरै राम्रो! तपाईंले डेमो सफलतापूर्वक पूरा गर्नुभयो!",
    successMessage: "🎉 सही!",
    failureMessage: "😢 अरे! गलत!",
    narration1: "अक्षरको आवाज सुन्नको लागि स्पिकर आइकनमा क्लिक गर्नुहोस्",
    narration2: "अक्षरको आवाज ध्यानपूर्वक सुन्नुहोस्",
    narration3: "अब, तलका विकल्पहरूबाट मिल्दो अक्षरमा क्लिक गर्नुहोस्",
    narration4: "धेरै राम्रो! तपाईंले डेमो सफलतापूर्वक पूरा गर्नुभयो!",
    howToPlay: "कसरी खेल्ने",
    demo: {
      audio: "अ",
      options: ["अ", "आ", "इ", "ई"],
      correctAnswer: "अ",
      explanation: "आवाज 'अ' अक्षर 'अ' सँग मिल्छ!",
    },
  },
};
